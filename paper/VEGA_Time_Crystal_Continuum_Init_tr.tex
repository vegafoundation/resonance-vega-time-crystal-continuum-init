...
\title{VEGA Time Crystal Continuum Init: Kavramsal Bir Çerçeve}
...
\begin{abstract}
Bu çalışma, VEGA Time Crystal Continuum Init'i Resonance Data ve QIRC paradigması içinde yeni bir kavramsal çerçeve olarak tanıtmaktadır.
